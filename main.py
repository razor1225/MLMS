...
if __name__ == '__main__':
	...
	def runGames():
		...
		allnets = np.append(nets, [brain.Bot.random(M) for x in range(fakeAgents)]) # Create unintellectual agents
	...
	for i in range(genCont, generations):
